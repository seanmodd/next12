...
import { cities as CITIES } from '../../../minimalComponents/map/assets/cities';
import { countries as COUNTRIES } from '../../../minimalComponents/map/assets/countries';
//
...
const MapHeatmap = lazy(() => import('../../../minimalComponents/map/map-heatmap'));
const MapGeojson = lazy(() => import('../../../minimalComponents/map/map-geojson'));
const MapClusters = lazy(() => import('../../../minimalComponents/map/MapClusters'));
const MapChangeTheme = lazy(() => import('../../../minimalComponents/map/map-change-theme'));
const MapZoomToBounds = lazy(() => import('../../../minimalComponents/map/MapZoomToBounds'));
const MapMarkersPopups = lazy(() => import('../../../minimalComponents/map/MapMarkersPopups'));
const MapDeckglOverlay = lazy(() => import('../../../minimalComponents/map/MapDeckglOverlay'));
const MapDynamicStyling = lazy(() => import('../../../minimalComponents/map/map-dynamic-styling'));
const MapInteraction = lazy(() => import('../../../minimalComponents/map/map-interaction'));
const MapDraggableMarkers = lazy(() => import('../../../minimalComponents/map/map-draggable-markers'));
const MapGeoJSONAnimation = lazy(() => import('../../../minimalComponents/map/MapGeoJSONAnimation'));
const MapHighlightByFilter = lazy(() => import('../../../minimalComponents/map/MapHighlightByFilter'));
const MapViewportAnimation = lazy(() => import('../../../minimalComponents/map/map-viewport-animation'));
